...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2021 at 06:29 AM
...
CREATE TABLE IF NOT EXISTS `course_result` (
  `course_result_id` int(11) NOT NULL,
...
INSERT INTO `course_result` (`course_result_id`, `course_code`, `course_name`, `course_credit`, `gpa`, `student_id`, `trimester`) VALUES
(1, 'ENG 1011', 'English I', '3', '3.67', 11171248, '1'),
(2, 'ENG 1013', 'English II', '3', '3.33', 11171248, '1'),
(3, 'SOC 2101', ' Society, Environment and Engineering Ethics', '3', '3.33', 11171248, '1');
...
(1, 'ENG 1011', 'English I', 'Language', '3', 'CSE'),
...
(104, '<br />\r\n<b>Notice</b>:  Undefined variable: data in <b>C:xampphtdocsfydpinsert2.php</b> on line <b>56</b><br />\r\n', '', '', '', 'CSE');
...
--
-- AUTO_INCREMENT for table `course_result`
--
ALTER TABLE `course_result`
  MODIFY `course_result_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
